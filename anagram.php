            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="p-3 mb-3 field-bg rounded-3">
                        ...
                        <p>Сайт <a class="link-success" href="/">Word Finder</a> поможет Вам решить анаграммы.</p>
                        ...
                        <p>Воспользоваться решением анаграмм на <a class="link-success" href="/">Word Finder</a> очень легко. Вам достаточно ввести слово или заданные буквы в указанное поле и система выдаст решения.</p>
                        </div>
                </div>
            </div>
            <div class="row justify-content-center">
